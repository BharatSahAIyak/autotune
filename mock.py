...
async def show_workflow(
    ...
    """
    with open(
        os.path.join(os.path.curdir, "apis", "mocks", "get.workflow.json"), "r"
    ) as f:
        data = json.load(f)
        return data
...
async def workflow(workflow_id=Query(title="workflow_id")):
    ...
    """
    with open(
        os.path.join(os.path.curdir, "apis", "mocks", "get.workflow.status.json"), "r"
    ) as f:
        data = json.load(f)
        return data
...
async def workflow(id: str, req: IterationRequest):
    ...
    """
    with open(
        os.path.join(os.path.curdir, "apis", "mocks", "post.workflow.iterate.id.json"),
        "r",
    ) as f:
        data = json.load(f)
        return data
...
async def workflow(id: str, req: GenerationRequest):
    ...
    """
    with open(
        os.path.join(os.path.curdir, "apis", "mocks", "post.workflow.generate.id.json"),
        "r",
    ) as f:
        data = json.load(f)
        return data
...
async def workflow():
    ...
    """
    with open(
        os.path.join(os.path.curdir, "apis", "mocks", "put.workflow.json"), "r"
    ) as f:
        data = json.load(f)
        return data
...
async def workflow(id: str):
    ...
    """
    with open(
        os.path.join(os.path.curdir, "apis", "mocks", "put.dataset.id.json"), "r"
    ) as f:
        data = json.load(f)
        return data
