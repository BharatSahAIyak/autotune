...
async def get_question(
    api_key, num_samples, content, model, system_prompt=None, user_prompt=None
):
    try:
...
async def generate_questions(
    ...
    if user_prompt:
        ...
        template = (
            template
            + "Answer as a leading industry expert explaining to a 7year 01old with no understanding of the question. \n"
        )
        template = (
            template
