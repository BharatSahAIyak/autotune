...
from .models import Workflows, Examples, User, MLModel, Dataset, Prompt
...
class WorkflowDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Workflows
        fields = ('workflow_id', 'workflow_name', 'total_examples', 'split',
                  'llm_model', 'cost', 'tags', 'user', 'dataset', 'model', 'examples', 'prompt', 'workflow_type')
...
class WorkflowSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Workflows
        fields = ('workflow_name', 'total_examples', 'split', 'llm_model', 'cost', 'tags', 'user', 'examples', 'workflow_type')
